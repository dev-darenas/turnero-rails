...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post turns_url, params: { turn: { cc: @turn.cc, code: @turn.code, specialty: @turn.specialty } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { cc: @turn.cc, code: @turn.code, specialty: @turn.specialty } }
